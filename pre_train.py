...
pre_train("MineRLTreechop-v0", demos, policy_net, target_net, optimizer, threshold=640, num_epochs=10, batch_size=16, seq_len=400, gamma=0.99,nstep=10, model_name='pre_trained8.pth')
